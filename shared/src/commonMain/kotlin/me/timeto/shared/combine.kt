...
inline fun <T1, T2, T3, T4, T5, T6, R> combine(
    ...
    transform(
        ...
        args[4] as T5, args[5] as T6,
    )
}

inline fun <T1, T2, T3, T4, T5, T6, T7, R> combine(
    flow1: Flow<T1>, flow2: Flow<T2>, flow3: Flow<T3>, flow4: Flow<T4>,
    flow5: Flow<T5>, flow6: Flow<T6>, flow7: Flow<T7>,
    ...
    transform(
        args[0] as T1, args[1] as T2, args[2] as T3, args[3] as T4,
        args[4] as T5, args[5] as T6, args[6] as T7,
    )
}
