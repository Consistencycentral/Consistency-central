...
class AutoBackupIos {
    ...
    /// Remember about habitarc-iOS-Info.plist, if I'm right, without NSUbiquitousContainers sync wouldn't work.
    ...
    static private func iCloudContainerUrl() -> URL? {
        ...
        // explicitly specify its address "iCloud.com.habitarc.app", but somehow it works.
